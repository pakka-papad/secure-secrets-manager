...
public interface SystemLockRepository extends JpaRepository<SystemLock, String> {
  ...
  /**
   * Finds a lock by its name and acquires a pessimistic write lock on the corresponding row, with a
   * timeout. If the lock cannot be acquired within the timeout period, a
